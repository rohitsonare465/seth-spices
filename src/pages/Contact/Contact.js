...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: '📞',
      title: 'Call Us',
      details: ['+91 98765 43210', '+91 141 234 5678', 'Mon-Sat: 9:00 AM - 6:00 PM']
    },
    {
      icon: '✉️',
      title: 'Email Us',
  ...
  const quickActions = [
    {
      ...
      action: 'https://wa.me/919876543210?text=Hi,%20I%20want%20to%20inquire%20about%20Seth%20Spices',
      color: 'green'
    },
    {
      icon: '📧',
